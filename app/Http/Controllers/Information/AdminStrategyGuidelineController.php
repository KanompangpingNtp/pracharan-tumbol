...
class AdminStrategyGuidelineController extends Controller
{
    public function  StrategyGuidelineAdmin()
    {
        ...
        return view('admin.post.strategy_guideline.page', compact('basicInfoDetail', 'basicInfoType'));
    }

    public function StrategyGuidelineCreate(Request $request)
    {
        $request->validate([
    ...
    public function StrategyGuidelineDelete($id)
    {
