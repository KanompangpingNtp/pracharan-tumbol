...
{
    public function NoticeBoardAdmin()
    {
    ...
    public function NoticeBoardShowData()
    {
        ...
        return view('pages.notice_board.show_data', compact('noticeBoard','personnelAgencies'));
    }
    ...
    public function NoticeBoardShowDetails($id)
    {
        ...
        return view('pages.notice_board.show_detail', compact('noticeBoard','personnelAgencies'));
    }
}
