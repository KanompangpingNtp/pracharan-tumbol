...
class AdminCanonController extends Controller
{
    public function CanonAdmin ()
    {
        ...
        return view('admin.post.laws_regs.canon.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function CanonCreate(Request $request)
    {
        $request->validate([
    ...
    public function CanonUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function CanonDelete($id)
    {
    ...
    public function CanonShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.laws_regs.canon.show_details', compact('PerfSingleTopic',));
    }

    public function CanonCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function CanonDertailsDelete($fileId)
    {
