...
class AdminAnnualActionPlanController extends Controller
{
    public function AnnualActionPlanAdmin()
    {
        ...
        return view('admin.post.local_development_plan.annual_plans.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function AnnualActionPlanCreate(Request $request)
    {
        $request->validate([
    ...
    public function AnnualActionPlanUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function AnnualActionPlanDelete($id)
    {
    ...
    public function AnnualActionPlanShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.local_development_plan.annual_plans.show_details', compact('PerfSingleTopic',));
    }

    public function AnnualActionPlanCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function AnnualActionPlanDertailsDelete($fileId)
    {
