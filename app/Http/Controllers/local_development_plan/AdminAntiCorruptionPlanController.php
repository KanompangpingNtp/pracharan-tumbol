...
class AdminAntiCorruptionPlanController extends Controller
{
    public function AntiCorruptionPlanAdmin()
    {
        ...
        return view('admin.post.local_development_plan.anti_corruption_plans.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function AntiCorruptionPlanCreate(Request $request)
    {
        $request->validate([
    ...
    public function AntiCorruptionPlanUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function AntiCorruptionPlanDelete($id)
    {
    ...
    public function AntiCorruptionPlanShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.local_development_plan.anti_corruption_plans.show_details', compact('PerfSingleTopic',));
    }

    public function AntiCorruptionPlanCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function AntiCorruptionPlanDertailsDelete($fileId)
    {
