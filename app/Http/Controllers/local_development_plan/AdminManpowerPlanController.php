...
{
    public function ManpowerPlanAdmin()
    {
        ...
        return view('admin.post.local_development_plan.manpower_plan.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function ManpowerPlanCreate(Request $request)
    {
        $request->validate([
    ...
    public function ManpowerPlanUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function ManpowerPlanDelete($id)
    {
    ...
    public function ManpowerPlanShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.local_development_plan.manpower_plan.show_details', compact('PerfSingleTopic',));
    }

    public function ManpowerPlanCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function ManpowerPlanDertailsDelete($fileId)
    {
