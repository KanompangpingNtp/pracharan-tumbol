...
{
    public function OperationalPlanAdmin()
    {
        ...
        return view('admin.post.local_development_plan.operational_plans.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function OperationalPlanCreate(Request $request)
    {
        $request->validate([
    ...
    public function OperationalPlanShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.local_development_plan.operational_plans.show_details', compact('PerfSingleTopic',));
    }

    public function OperationalPlanCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function OperationalPlanDertailsDelete($fileId)
    {
