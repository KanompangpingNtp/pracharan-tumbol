...
class AdminFinancialStatementController extends Controller
{
    public function FinancialStatementAdmin()
    {
        ...
        return view('admin.post.performance_results.financial_statement.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function FinancialStatementCreate(Request $request)
    {
        $request->validate([
    ...
    public function FinancialStatementUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function FinancialStatementDelete($id)
    {
    ...
    public function FinancialStatementShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.performance_results.financial_statement.show_details', compact('PerfSingleTopic',));
    }

    public function FinancialStatementCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function FinancialStatementDertailsDelete($fileId)
    {
