...
class AdminHRManagementDevelopmentController extends Controller
{
    public function HRManagementDevelopmentAdmin()
    {
        ...
        return view('admin.post.performance_results.hrmanagement_development.page', compact('PerfResultsDetail', 'perfResultsType'));
    }

    public function HRManagementDevelopmentCreate(Request $request)
    {
        $request->validate([
    ...
    public function HRManagementDevelopmentUpdate(Request $request, $id)
    {
        $request->validate([
            // 'perf_results_type' => 'required|exists:perf_results_types,id',
            'detail_name' => 'required|string',
    ...
    public function HRManagementDevelopmentDelete($id)
    {
    ...
    public function HRManagementDevelopmentShowDertails($id)
    {
        $PerfResultsDetail = PerfResultsDetail::findOrFail($id);
        $PerfResultsMinorDetail = PerfResultsMinorDetail::where('perf_results_detail_id', $id)->get();

        return view('admin.post.performance_results.hrmanagement_development.show_details', compact('PerfResultsDetail', 'PerfResultsMinorDetail'));
    }

    public function HRManagementDevelopmentDertailsCreate(Request $request, $FinancialId)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function HRManagementDevelopmentDertailsUpdate(Request $request, $id)
    {
    ...
    public function HRManagementDevelopmentDertailsDelete($id)
    {
    ...
    public function HRManagementDevelopmentShowDertailResults($id)
    {
        $PerfResultsMinorDetail = PerfResultsMinorDetail::with('files')->findOrFail($id);

        return view('admin.post.performance_results.hrmanagement_development.show_detail_results', compact('PerfResultsMinorDetail',));
    }

    public function HRManagementDevelopmentDertailsCreateResults(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function HRManagementDevelopmentDertailsDeleteResults($fileId)
    {
