...
class AdminHRPolicyController extends Controller
{
    public function HRPolicyAdmin()
    {
        ...
        return view('admin.post.performance_results.hrpolicy.page', compact('PerfResultsDetail', 'perfResultsType'));
    }

    public function HRPolicyCreate(Request $request)
    {
        $request->validate([
    ...
    public function HRPolicyDelete($id)
    {
    ...
    public function HRPolicyShowDertails($id)
    {
        $PerfResultsDetail = PerfResultsDetail::findOrFail($id);
        $PerfResultsMinorDetail = PerfResultsMinorDetail::where('perf_results_detail_id', $id)->get();

        return view('admin.post.performance_results.hrpolicy.show_details', compact('PerfResultsDetail', 'PerfResultsMinorDetail'));
    }

    public function HRPolicyDertailsCreate(Request $request, $FinancialId)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function HRPolicyDertailsUpdate(Request $request, $id)
    {
    ...
    public function HRPolicyDertailsDelete($id)
    {
    ...
    public function HRPolicyShowDertailResults($id)
    {
        $PerfResultsMinorDetail = PerfResultsMinorDetail::with('files')->findOrFail($id);

        return view('admin.post.performance_results.hrpolicy.show_detail_results', compact('PerfResultsMinorDetail',));
    }

    public function HRPolicyDertailsCreateResults(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function HRPolicyDertailsDeleteResults($fileId)
    {
