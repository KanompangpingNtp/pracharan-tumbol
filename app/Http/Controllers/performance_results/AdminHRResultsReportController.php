...
class AdminHRResultsReportController extends Controller
{
    public function HRResultsReportAdmin()
    {
        ...
        return view('admin.post.performance_results.hrresults_report.page', compact('PerfResultsDetail', 'perfResultsType'));
    }

    public function HRResultsReportCreate(Request $request)
    {
        $request->validate([
    ...
    public function HRResultsReportUpdate(Request $request, $id)
    {
        $request->validate([
            // 'perf_results_type' => 'required|exists:perf_results_types,id',
            'detail_name' => 'required|string',
    ...
    public function HRResultsReportDelete($id)
    {
    ...
    public function HRResultsReportShowDertails($id)
    {
        $PerfResultsDetail = PerfResultsDetail::findOrFail($id);
        $PerfResultsMinorDetail = PerfResultsMinorDetail::where('perf_results_detail_id', $id)->get();

        return view('admin.post.performance_results.hrresults_report.show_details', compact('PerfResultsDetail', 'PerfResultsMinorDetail'));
    }

    public function HRResultsReportDertailsCreate(Request $request, $FinancialId)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function HRResultsReportDertailsUpdate(Request $request, $id)
    {
    ...
    public function HRResultsReportDertailsDelete($id)
    {
    ...
    public function HRResultsReportShowDertailResults($id)
    {
        $PerfResultsMinorDetail = PerfResultsMinorDetail::with('files')->findOrFail($id);

        return view('admin.post.performance_results.hrresults_report.show_detail_results', compact('PerfResultsMinorDetail',));
    }

    public function HRResultsReportDertailsCreateResults(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function HRResultsReportDertailsDeleteResults($fileId)
    {
