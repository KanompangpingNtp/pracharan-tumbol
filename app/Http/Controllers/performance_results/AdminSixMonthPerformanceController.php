...
class AdminSixMonthPerformanceController extends Controller
{
    public function SixMonthPerformanceAdmin()
    {
        ...
        return view('admin.post.performance_results.sixmonth_performance.page', compact('PerfResultsDetail', 'perfResultsType'));
    }

    public function SixMonthPerformanceCreate(Request $request)
    {
        $request->validate([
    ...
    public function SixMonthPerformanceUpdate(Request $request, $id)
    {
        $request->validate([
            // 'perf_results_type' => 'required|exists:perf_results_types,id',
            'detail_name' => 'required|string',
    ...
    public function SixMonthPerformanceDelete($id)
    {
    ...
    public function SixMonthPerformanceShowDertails($id)
    {
        $PerfResultsDetail = PerfResultsDetail::findOrFail($id);
        $PerfResultsMinorDetail = PerfResultsMinorDetail::where('perf_results_detail_id', $id)->get();

        return view('admin.post.performance_results.sixmonth_performance.show_details', compact('PerfResultsDetail', 'PerfResultsMinorDetail'));
    }

    public function SixMonthPerformanceDertailsCreate(Request $request, $FinancialId)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function SixMonthPerformanceDertailsUpdate(Request $request, $id)
    {
    ...
    public function SixMonthPerformanceDertailsDelete($id)
    {
    ...
    public function SixMonthPerformanceShowDertailResults($id)
    {
        $PerfResultsMinorDetail = PerfResultsMinorDetail::with('files')->findOrFail($id);

        return view('admin.post.performance_results.sixmonth_performance.show_detail_results', compact('PerfResultsMinorDetail',));
    }

    public function SixMonthPerformanceDertailsCreateResults(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function SixMonthPerformanceDertailsDeleteResults($fileId)
    {
