...
class AdminWorkProcedureController extends Controller
{
    public function WorkProcedureAdmin()
    {
        ...
        return view('admin.post.performance_results.work_procedure.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function WorkProcedureCreate(Request $request)
    {
        $request->validate([
    ...
    public function WorkProcedureUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function WorkProcedureDelete($id)
    {
    ...
    public function WorkProcedureShowDertails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.performance_results.work_procedure.show_details', compact('PerfSingleTopic',));
    }

    public function WorkProcedureCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function WorkProcedureDertailsDelete($fileId)
    {
