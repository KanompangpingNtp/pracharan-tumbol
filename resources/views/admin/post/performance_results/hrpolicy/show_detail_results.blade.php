...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('HRPolicyDertailsCreateResults', $PerfResultsMinorDetail->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <tr>
            ...
            <td class="text-center align-middle">
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <form action="{{ route('HRPolicyDertailsDeleteResults', $file->id) }}" method="POST" onsubmit="return confirm('คุณต้องการลบไฟล์นี้หรือไม่?');">
                        @csrf
                        @method('DELETE')
