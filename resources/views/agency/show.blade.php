                                            ...
                                            <div class="col-md-4">
                                                <div
                                                    ...
                                                    @if ($detail->images->count() > 0)
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <img src="{{ asset('backend/images/images.png') }}"
                                                            alt="Personnel Image"
                                                    ...
                                                    <div class="fs-4 mt-2">
                                                        ...
                                                        @if (!empty($detail->phone))
                                                            <div class="fs-4 text-center p-1 fw-bold"
                                                                ...
                                                                <a href="tel:{{ $detail->phone }}"
                                                                    class="bg-dark text-white px-2 fs-5 hotline-btn"
                                                                    style="border-radius: 20px;">สายด่วน</a>
                                                                {{ $detail->phone }}
                                                            </div>
                                                        @endif
                                                        ...
                                                        <style>
                                                            ...
                                                            .hotline-btn:hover {
                                                                transform: scale(1.1);
                                                                /* ขยายขนาดเมื่อ hover */
                                                                filter: drop-shadow(0 0 8px rgba(117, 255, 37, 0.8));
                                                                /* เรืองแสงสีขาว */
                                                            }
                                                        </style>
                                                    </div>
