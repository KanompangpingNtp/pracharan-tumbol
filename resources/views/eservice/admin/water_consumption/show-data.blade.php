...
<div class="container">
    <h2 class="text-center">คำร้องขอสนับสนุนน้ำเพื่ออุปโภค-บริโภค <br>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="{{ route('WaterConsumptionAdminExportPDF', $form->id) }}" class="btn btn-danger btn-sm" target="_blank">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <form action="{{ route('WaterConsumptionUpdateStatus', $form->id) }}" method="POST">
                    @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('WaterConsumptionAdminReply', $form->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
