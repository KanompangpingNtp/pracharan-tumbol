...
<form action="{{ route('ChildApplyFormCreate') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <h3 class="text-center">ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์</h3>
        ...
        <div class="col-md-12">
            ...
            <span class="ms-4">1. ข้าพเจ้าขอรับรองว่า ได้อ่านประกาศรับสมัครศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์เข้าใจแล้ว เด็กที่นำมาสมัครมีคุณสมบัติถูกต้องตรงประกาศ และหลักฐานที่ใช้สมัครใน
                 วันนี้เป็นหลักฐานที่ถูกต้องจริง <br>
            </span>
            <span class="ms-4">2. ข้าพเจ้ามีสิทธิถูกต้องในการที่จะให้เด็กสมัครเข้ารับการศึกษาเลี้ยงดูในศูนย์พัฒนาเด็กเล็กของเทศบาลตำบลพระอาจารย์ <br></span>
            <span class="ms-4">3. ข้าพเจ้ายินดีปฏิบัติตามระเบียบ ข้อกำหนดเทศบาลตำบลพระอาจารย์ และยินดีปฏิบัติตามคำแนะนำเกี่ยวกับการพัฒนาความพร้อมที่ศูนย์พัฒนาเด็กเล็ก กำหนด</span>
            <br>
            <br>
            <span><strong>หมายเหตุ</strong> เอาข้อมูลเอกสาร/หลักฐานที่ใช้ในการสมัครเรียน ให้นำมาพร้อมนักเรียน ติดต่อมอบตัว ภายใน 7วัน ทำการที่ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์</span>
        </div>
        ...
        <h3 class="text-center">ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ <br></h3>
        <h4 class="text-center"><span class="text-danger">** </span><strong>หากไม่มีการกรอกข้อมูล กรุณาใส่เครื่องหมาย - แทน</strong></h4><br>
        ...
        <div style="margin-top: 20px;">
            <span>เข้าเป็นนักเรียนของศูนย์ พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์และพร้อมที่จะปฏิบัติตามระเบียบการของศูนย์พัฒนาเด็กเล็กองค์การบริหารส่วนตำบลหนองบ้านโพธิ์ ดังนี้</span><br>
            <span class="ms-5"> 1. จะปฏิบัติตามระเบียบ ข้อบังคับของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ อย่างเคร่งครัด</span><br>
            <span class="ms-5"> 2. จะร่วมมือกับศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ ในการจัดการเรียนการสอนและขจัดปัญหาต่างๆ ที่อาจเกิดขึ้นแก่เด็กอย่างใกล้ชิด
            </span>
        </div>
        <div class="row">
