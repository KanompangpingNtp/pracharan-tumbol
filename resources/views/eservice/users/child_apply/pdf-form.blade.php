...
<body>
    ...
    <div class="title_doc" style="text-align:center;">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/header/logo.png'))) }}" alt="Logo">
        <div>
            ใบสมัคร
        </div>
        ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์
    </div>
    <div class="regis_number" style="margin-top:2rem;">เขียนที่ ศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์
    </div>
    ...
    <div class="box_text" style="text-align: left; margin-top: 5px; ">
        <div style="margin-left: 2rem;"> ๓. ข้าพเจ้ายินดีปฏิบัติตามระเบียบ
            ข้อกำหนดของเทศบาลตำบลพระอาจารย์ และยินดี
    ...
    <div class="title_doc" style="text-align:center;">
        ...
        <div>
            เทศบาลตำบลพระอาจารย์ อำเภอองครักษ์ จังหวัดนครนายก
        </div>
    </div>
    <div class="box_text" style="text-align: left; margin-top: 1rem; ">
        ...
        <div> {{$form->surrenderTheChild->first()->child_surrender_salutation1}} <span class="dotted-line" style="width: 65%; text-align: left; margin-top:20px;">{{ $form->surrenderTheChild->first()->childs_name }}
            ...
            <div>พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ และพร้อมที่จะปฏิบัติตามระเบียบการของศูนย์</div>
            <div>พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ ดังนี้</div>
        </div>
        <div style="margin-left: 2rem;"> 1. จะปฏิบัติตามระเบียบ
            ข้อบังคับของศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์ อย่างเคร่งครัด
        </div>
        <div style="margin-left: 2rem;"> 2. จะร่วมมือกับศูนย์พัฒนาเด็กเล็กเทศบาลตำบลพระอาจารย์
    ...
    {{-- <div class="box_text" style="text-align: left; margin-top: 5px; ">
        <div> (นาย/นาง/นางสาว) <span class="dotted-line" style="width: 83%; text-align: center; margin-top:20px;">{{ $form->surrenderTheChild->first()->child_recipient }}
    </span> โดยเกี่ยวข้องเป็น <span class="dotted-line" style="width: 85%; text-align: center; margin-top:20px;"> {{ $form->surrenderTheChild->first()->child_recipient_relevant }} </span> เบอร์โทรศัพท์ติดต่อ <span class="dotted-line" style="width: 83%; text-align: center; margin-top:20px;"> {{ $form->surrenderTheChild->first()->child_recipient_phone }}</div>
        </div> --}}
        <div class="box_text" style="text-align: left; margin-top: 5px;">
