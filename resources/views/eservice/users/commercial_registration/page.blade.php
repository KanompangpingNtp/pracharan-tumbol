...
<div class="container">
    <h4 class="text-center mb-4">คำร้องทะเบียนพาณิชย์</h4>

    <form action="{{ route('TradeRegistryFormCreate') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <h4 class="form-label">ประเภทคำขอ</h4>
        ...
        <br>
        <h4 class="form-label">(1) ชื่อผู้ประกอบการ</h4>
        ...
        <br>
        <h4 class="form-label">(2) ชื่อที่ใช้ในการประกอบพาณิชยกิจ</h4>
        ...
        <br>
        <h4 class="form-label">(3) ชนิดแห่งพาณิชยกิจ</h4>
        ...
        <br>
        <h4 class="form-label">(4) จำนวนเงินทุนที่นำมาใช้ในการประกอบพาณิชยกิจเป็นประจำ</h4>
        ...
        <br>
        <h4 class="form-label">(5) ที่ตั้งสำนักงานใหญ่</h4>
        <div class="row">
            <div class="mb-3 col-md-4">
        ...
        <!-- ข้อมูลผู้จัดการ -->
        <br>
        <h4 class="form-label">(6) ข้อมูลผู้จัดการ</h4>
        <div class="row">
            <div class="mb-3 col-md-4">
        ...
        <br>
        <h4 class="form-label">(7) วันที่เริ่มต้นประกอบพาณิชยกิจในประเทศไทย</h4>
        <div class="mb-3 col-md-3">
        ...
        <br>
        <h4 class="form-label">(8) วันที่ขอจดทะเบียนพาณิชย์</h4>
        <div class="mb-3 col-md-3">
        ...
        <!-- รับโอนเงินพาณิชย์ -->
        <br>
        <h4 class="form-label">(9) รับโอนพาณิชยกิจนี้จาก</h4>
        <div class="row">
            <div class="mb-3 col-md-3">
        ...
        <br>
        <h4 class="form-label">(10) ที่ตั้งสำนักงานสาขา</h4>
        <div class="row">
            <div class="mb-3 col-md-3">
        ...
        <!-- ที่ตั้งคลังสินค้า -->
        <br>
        <h4 class="form-label">ที่ตั้งโรงเก็บสินค้า</h4>
        <div class="row">
            <div class="mb-3 col-md-3">
        ...
        <!-- ตัวแทนค้าต่าง -->
        <br>
        <h4 class="form-label">ตัวแทนค้าต่าง</h4>
        <div class="row">
            <div class="mb-3 col-md-3">
        ...
        <br>
        <h4 class="form-label">(11) ชื่อ อายุ เชื้อชาติ สัญชาติ ตำบลที่อยู่ และจำนวนทุนลงหุ้นของผู้เป็นหุ้นส่วนและจำนวนเงินทุนของห้างหุ้นส่วน</h4>
        ...
        <br>
        <h4 class="form-label">(12) จำนวนเงินทุน จำนวนหุ้น และมุลค่าหุ้นของบริษัทจำกัด จำนวนและมูลค่าหุ้นที่บุคคลแต่ละสัญชาติถืออยู่</h4>
        <div class="row">
            {{-- <div class="mb-3 col-md-3">
        ...
        <br>
        <h4 class="form-label">(13) ผู้เป็นหุ้นส่วนออกหรือตาย</h4>
        ...
        <div>
            <h4 for="attachments" class="form-label">แนบไฟล์</h4>
