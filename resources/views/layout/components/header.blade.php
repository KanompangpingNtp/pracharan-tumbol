            ...
            <div class="bg-menu w-100 pb-2 pt-3">
                ...
                <div>บุคลากร</div>
                    ...
                    <div
                        class="custom-dropdown-container d-flex flex-column align-items-center justify-content-center position-relative">
                        <a class="custom-hover-trigger navbar-item d-flex flex-column align-items-center">
                            <img src="{{ asset('images/header/online-survey.png') }}" alt="teamwork"
                                class="navbar-icon">
                        ...
                        <ul class="custom-dropdown-menu text-start">
                            <li>
                                ...
                                <a href="{{ route('PerformanceReportPage') }}"
                                    class="dropdown-item">รายผลการดำเนินงาน</a>
                                <a href="{{ route('MonitoringEvaluationPage') }}"
                                    class="dropdown-item">รายงานการติดตามและประเมิน</a>
                                <a href="{{ route('AnnualBudgetPage') }}"
                                    class="dropdown-item">งบประมาณรายจ่ายประจำปี</a>
                                <a href="{{ route('SixMonthPerformancePage') }}"
                                    class="dropdown-item">รายงานผลการดำเนินงานรอบ 6 เดือน</a>
                                <a href="{{ route('OperationPage') }}" class="dropdown-item">การปฏิบัติงาน</a>
                                <a href="{{ route('HRPolicyPage') }}"
                                    class="dropdown-item">นโยบายการบริหารทรัพยากรบุคคล</a>
                                <a href="{{ route('HRPolicyManagementPage') }}"
                                    class="dropdown-item">การดำเนินการตามนโยบายและการบริหารทรัพยากรบุคคล</a>
                                <a href="{{ route('HRManagementDevelopmentPage') }}"
                                    class="dropdown-item">หลักเกณฑ์การบริหารและพัฒนาทรัพยากรบุคคล</a>
                                <a href="{{ route('HRResultsReportPage') }}"
                                    class="dropdown-item">รายงานผลการบริหารและพัฒนาทรัพยากรบุคคล</a>
                                <a href="{{ route('TransparencyPage') }}"
                                    class="dropdown-item">มาตรการส่งเสริมความโปร่งใสและป้องกันการทุจริต</a>
                                <a href="{{ route('FinancialStatementPage') }}"
