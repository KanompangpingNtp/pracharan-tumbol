...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5">
            <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">แผนงานป้องกันการทุจริต</div>
            <style>
                .table td:hover {
            ...
            <table class="table">
                ...
                <tr>
                    <td><a href="{{route('AntiCorruptionPlanDertail',$detail->id)}}">{{ $detail->detail_name }}</a></td>
                </tr>
                @endforeach
            </table>
