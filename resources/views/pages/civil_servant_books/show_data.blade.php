...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center align-items-center p-5">
            <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">หนังสือข้าราชการ จากกรมส่งเสริมการปกครองท้องถิ่น</div>
            ...
            <table class="table">
                @foreach($LocalAdminPromotion as $detail)
                <tr>
                    <td><a href="{{route('CivilServantDetails',$detail->id)}}">{{ $detail->title_name }}</a></td>
                </tr>
                @endforeach
            </table>
