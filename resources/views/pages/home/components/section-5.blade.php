...
@media (max-width: 576px) { /* เมื่อจอเล็กกว่า sm */
    .responsive-img {
        height: 250px;
        width: 100%;
    }
...
<main class="bg-section5 d-flex">
    <div class="container d-flex flex-column flex-xl-row justify-content-center align-items-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
            <img src="{{ asset('images/home/section-5/title.png') }}" alt="title" class="img-fluid">
     ...
     @foreach ($pressRelease->slice(0, 6) as $index=> $post)
            <div class="col">
                <a href="{{ route('PressReleaseShowDetails', $post->id) }}" class="text-decoration-none text-black">
                    <div class="card d-flex flex-column flex-sm-row p-3 border-0 custom-card gap-2"
                        ...
                        <img src="{{ !empty($post->photos->first()->post_photo_file) ? asset('storage/' . $post->photos->first()->post_photo_file) : asset('images/home/section-4/logo-miss-files.png') }}"
                            class="card-img-top bg-white mx-auto responsive-img" alt="Image {{ $index + 1 }}"
                            onerror="this.onerror=null; this.src='{{ asset('images/home/section-4/logo-miss-files.png') }}';">

                        <!-- เนื้อหาข้อความ -->
                        <div class="card-body p-1 bg-white ms-2 ms-sm-0 mt-sm-2 lh-1 text-center text-sm-start"
                            style="border-radius: 10px;">
                            <div
                                class="d-flex border-bottom align-items-center mb-1 pb-1 justify-content-center justify-content-sm-start">
