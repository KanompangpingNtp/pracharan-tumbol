...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center p-5">
            <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">รับเรื่องราวร้องทุกข์ของประชาชน</div>
            ...
            <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="col-md-10">
                    <form action="{{route('ReceiveComplaintsFormCreate')}}" method="POST" enctype="multipart/form-data">
                        @csrf
