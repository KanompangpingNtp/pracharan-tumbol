...
<div class="bg py-5">
    <div class="container py-5 custom-gradient-shadow">
        <div class=" d-flex flex-column justify-content-center align-items-center p-5 ">
            <div class="fs-1 fw-bold mb-4 text-center" style="color: #77b329;">ประกาศจัดซื้อจัดจ้าง</div>
            ...
            <table class="table">
                ...
                <tr>
                    <td><a href="{{route('ProcurementShowDetails',$detail->id)}}">{{ $detail->title_name }}</a></td>
                </tr>
                @endforeach
            </table>
